 ...
 * @final 21/04/2013
 */ 
class StudentshipModelsScholarship_value  extends FSModels
{
    var $limit;
    var $prefix;
    function __construct()
    {
        parent::__construct();
        $this->limit = 20;
        $this->view = 'scholarship_value';
        $this->table_types = 'scholarship_value';
        $this->table_name = 'fs_studentship_scholarship_value';
        $this->check_alias = 0;
    }
    function setQuery()
    {
