 ...
 * @final 21/04/2013
 */ 
class StudentshipModelsRegisters  extends FSModels
{
    var $limit;
    var $prefix;
    function __construct()
    {
        ...
        $this->limit = 20;
        $this->view = 'registers';
        $this->table_types = 'registers';
        $this->table_name = 'fs_studentship_registers';
        $this->check_alias = 0;
    }
    function setQuery()
    {
        ...
        if (isset($_SESSION[$this->prefix . 'keysearch']))
        {
            if ($_SESSION[$this->prefix . 'keysearch'])
            {
                ...
                $where .= " AND a.fullname LIKE '%" . $keysearch . "%' ";
            }
        }
        $query = "  SELECT a.*
                    FROM 
