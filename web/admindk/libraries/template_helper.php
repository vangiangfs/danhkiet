					...
					foreach($col as $item){
						...
						switch($type){
							...
							case 'image':
								...
								if($have_link_edit)
									$html_body .= '<a href="'.$link_view.'"><img onerror="this.src=\'/images/spacer.gif\'" src="'.URL_ROOT.$link_img.'" '.$html_size.' /></a>';
								else
									$html_body .= '<img onerror="this.src=\'/images/spacer.gif\'" src="'.URL_ROOT.$link_img.'" '.$html_size.' />';
								break;
							case 'text':
							default:
