 ...
 * @final 21/04/2013
 */ 
class StudentshipModelsLevel_education  extends FSModels
{
    var $limit;
    var $prefix;
    function __construct()
    {
        parent::__construct();
        $this->limit = 20;
        $this->view = 'level_education';
        $this->table_types = 'level_education';
        $this->table_name = 'fs_studentship_level_education';
        $this->check_alias = 0;
    }
    function setQuery()
    {
