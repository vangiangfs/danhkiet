...
export default class ChinhSuaThongTinTaiKhoanKyThuat extends Component{
	render() {
		return (
            <ScrollView>
                <View style = {mainStyle.header}>
                    ...
                    <View style = {mainStyle.containTextHeader4}>
                        <Text style = {mainStyle.textHeader}>Chỉnh sửa thông tin tài khoản</Text>
                    </View>
                        <TouchableOpacity>
                            <Image source = {require('../assets/15-thongtintaikhoan---chinhsua.png')} 
                ...
                <View style = {mainStyle.body}>
                    ...
                    <View style = {mainStyle.leftAndRight}>
                        <View style = {mainStyle.left}>
                            <TouchableOpacity style = {{width:'100%',height:120 * standarHeight/height, backgroundColor:'#f0f0f0'}}>
                                <Image source = {require('../assets/1.png')} style = {{height:'100%',width:'100%', resizeMode:'cover'}}></Image>
                            </TouchableOpacity>
                        </View>
                        <View style = {mainStyle.right}>
                            <TouchableOpacity style = {{width:'100%',height:120 * standarHeight/height,backgroundColor:'#f0f0f0'}}>
                    ...
                    <View style = {mainStyle.address}>
                        ...
                        <View style = {mainStyle.textArea2}>
                            <TextInput style={{height:150,textAlign:'center'}}
                                underlineColorAndroid="transparent"
                                value="Có kinh nghiệm 20 năm trong ngành đo đạc và xây dựng các công trình đo đạc và xây dựng các công trình lớn trong và ngoài nước."
                                numberOfLines={10}
                                multiline={true}
                                />
                        </View>
                    ...
                    <View style = {mainStyle.address}>
                        ...
                        <View style = {mainStyle.textArea2}>
                            <TextInput style={{height:150,textAlign:'center'}}
                                underlineColorAndroid="transparent"
                                value ="Nhà Quốc Hội, Trung tâm Hội nghị Quốc gia Việt Nam, Sân vận động quốc gia Mỹ Đình, Keangnam Hanoi Landmark Tower, Lotte Center Hanoi, Bitexco Financial Tower."
                                numberOfLines={10}
                                multiline={true}
                                />
                        </View>
