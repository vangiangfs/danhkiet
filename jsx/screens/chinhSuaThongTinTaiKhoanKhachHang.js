...
export default class ChinhSuaThongTinTaiKhoanKhachHang extends Component{
	render() {
		return (
            <View style = {mainStyle.container}>
                <View style = {mainStyle.header}>
                    ...
                    <View style = {mainStyle.containTextHeader4}>
                        <Text style = {mainStyle.textHeader}>Chỉnh sửa thông tin khách hàng</Text>
                    </View>
                    <View>
                        <TouchableOpacity>
                ...
                <View style = {mainStyle.body6}>
                    <View style ={mainStyle.name_taiKhoan}>
                        <TextInput style = {{textAlign:'center',fontWeight:'bold',fontSize:text16}} value = {"Nguyễn Bích Vân"}></TextInput>
                    </View>
