...
export default class ThongTinKyThuat_BatMay extends Component {
        ...
        return(
            <ImageBackground source = {require('../assets/backgroundImage4.png')} style = {mainStyle.container}>
                ...
                <View style = {mainStyle.content_goi_2}>
                    ...
                    <Text style = {{color:'#ffffff'}}>00:59</Text>
                </View>
                <View style = {mainStyle.content_goi_3}>
                    ...
                    <View style = {mainStyle.content_goi_3b}>
                        <TouchableOpacity style = {mainStyle.iconGoi_checked}>
                            <Image source={require('../assets/loaNgoai.png')} style = {{width:30, height:30, resizeMode:'stretch'}}></Image>
                        </TouchableOpacity>
                        <View style = {{flex:2,marginTop:5}}>
