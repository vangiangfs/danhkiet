            ...
            <ScrollView>
                ...
                <View style = {mainStyle.body4}>
                    ...
                    <View style = {mainStyle.content2_body4}>
                        ...
                        <View style = {mainStyle.containTextInput2}>
                            <View style ={mainStyle.containIconTextInput}>
                                <Image source = {require('../assets/iconLocation.png')} style = {mainStyle.iconTextInput}></Image>
                            </View>
                            <TextInput style = {mainStyle.inputText} placeholder = {'Khoảng cách'}></TextInput>
                            <View style ={mainStyle.containIconTextInput}>
                                <TouchableOpacity>
                        ...
                        <View style = {mainStyle.containTextInput2}>
                            ...
                            <TextInput style = {mainStyle.inputText} placeholder = {'Địa chỉ cần đo'}></TextInput>
                            <View style ={mainStyle.containIconTextInput}>
                            </View>
                        </View>
                        <View style = {mainStyle.containTextInput2}>
                    ...
                    <View style ={mainStyle.content3_body4}>
                        <Text style ={{fontSize:7,textAlign:'center',}}>ĐÀO TẠO KỸ THUẬT TRẮC ĐỊA CHUYÊN NGHIỆP CHO CÁC CÔNG TY</Text>
                    </View>
                </View>
                <View style = {mainStyle.footer4}>
                    <TouchableOpacity style = {mainStyle.buttonDangNhap2} >
                        <Text style ={mainStyle.textButtonDangKy}>TÌM KIẾM</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
        );
